...
const openSlots: Slot[] = [
  {
    id: "org-sec",
    title: "SRC Organizing Secretary",
    fee: 150,
    requirements: [
      "Minimum CGPA of 2.5",
      "Level 200 or above",
  ...
  },
  {
    ...
    fee: 200,
    requirements: [
      "Accounting/Finance related program preferred",
      "Level 300 or above",
      "Clean financial standing",
    ],
  },
  {
    id: "pro",
              ...
              <ul className="mt-4 space-y-1.5 text-sm text-gray-600 flex-1">
                {s.requirements.map((r) => (
                  <li key={r} className="flex gap-2">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#0C1E4E]" />
                    <span>{r}</span>
                  </li>
                ))}
              </ul>
